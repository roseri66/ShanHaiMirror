...
namespace SHMTags
{
	...
	// --- 规则修改器（决策层选择，玩法层作用面在伤害/冷却计算里消费）---
	SHANHAIMIRROR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Rule_Ammo);
	SHANHAIMIRROR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Rule_Heal);
	SHANHAIMIRROR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Rule_Cooldown);
	SHANHAIMIRROR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Rule_MeleeDamage);
	SHANHAIMIRROR_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Rule_RangedDamage);
}
